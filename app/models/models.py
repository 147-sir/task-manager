...
from sqlalchemy import DateTime, func, Integer, String, Boolean, Text, ForeignKey
...
class LoginLog(Base):
    ...
    ip: Mapped[str] = mapped_column(String(255), nullable=False, comment='登录IP')
    user_agent: Mapped[str] = mapped_column(String(255), nullable=False, comment='登录设备')
